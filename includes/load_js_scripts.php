...
// Registro todos los archivos js necesarios para la web
    ...
    wp_register_script( 'main-script', get_template_directory_uri() . '/js/main.js', array('jqueryScript', 'menuScript', 'sliderEquipoScript', 'contadorServiciosScript', 'contactoSliderScript','formulario'), '1.0', true );
