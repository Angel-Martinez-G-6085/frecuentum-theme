...
// Registro todos los archivos js necesarios para la web
    ...
    wp_register_script( 'event-calendar', get_template_directory_uri() . '/js/modal/event-calendar.js', false, '1.0', true );
    ...
    wp_register_script( 'main-script', get_template_directory_uri() . '/js/main.js', array('jqueryScript', 'jqueryUIScript', 'menuScript', 'sliderEquipoScript', 'contadorServiciosScript', 'contactoSliderScript', 'modal', 'ajax-modal', 'formulario','event-calendar'), '1.0', true );
